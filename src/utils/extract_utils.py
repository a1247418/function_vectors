...
def compute_universal_function_vector(mean_activations, model, model_config, n_top_heads=10):
    ...
    if 'gpt-j' in model_config['name_or_path']:
        ...
        top_heads = [(12, 20, 0.1592), (14, 12, 0.0452), (14, 1, 0.0433), (12, 17, 0.0137), (17, 17, 0.0113), (10, 22, 0.0106), (15, 4, 0.0106), (14, 14, 0.01), (12, 23, 0.0083), (12, 3, 0.0077),
                    (13, 4, 0.0065), (26, 14, 0.0063), (10, 23, 0.0053), (15, 7, 0.0052), (15, 9, 0.0052), (9, 19, 0.0046), (12, 6, 0.0045), (13, 14, 0.0045), (19, 7, 0.0045), (14, 5, 0.0044),
                    (17, 0, 0.0042), (14, 16, 0.004), (13, 15, 0.0039), (12, 16, 0.0038), (17, 2, 0.0036), (16, 21, 0.0032), (13, 6, 0.0031), (13, 11, 0.003), (24, 21, 0.003), (23, 10, 0.0029),
                    (16, 16, 0.0028), (11, 16, 0.0027), (27, 9, 0.0025), (16, 3, 0.0024), (14, 8, 0.0023), (26, 20, 0.0023), (13, 23, 0.0022), (14, 22, 0.0022), (27, 17, 0.0021), (14, 0, 0.002),
                    (13, 8, 0.0019), (26, 23, 0.0019), (8, 2, 0.0018), (13, 16, 0.0018), (13, 20, 0.0018), (14, 2, 0.0017), (14, 18, 0.0017), (27, 18, 0.0017), (10, 0, 0.0016), (13, 19, 0.0016)]
    elif 'gemma-3-4b-pt' in model_config['name_or_path']:
        top_heads = [(13, 2, 0.0695), (17, 6, 0.0531), (17, 4, 0.0483), (22, 3, 0.0212), (17, 5, 0.017), (11, 0, 0.0145), (18, 7, 0.0131), (18, 1, 0.0128), (14, 6, 0.0099), (19, 4, 0.0086),
                    (20, 7, 0.0079), (29, 0, 0.0077), (11, 1, 0.0075), (11, 4, 0.006), (22, 0, 0.0057), (30, 4, 0.0053), (14, 5, 0.0051), (16, 7, 0.0049), (16, 4, 0.0043), (17, 3, 0.0042),
                    (18, 3, 0.0038), (20, 0, 0.0037), (22, 7, 0.0037), (25, 4, 0.0037), (27, 6, 0.0034), (20, 4, 0.0033), (16, 0, 0.0031), (19, 1, 0.003), (19, 7, 0.0028), (16, 6, 0.0027)]
    elif 'gemma-3-4b-it' in model_config['name_or_path']:
        top_heads = [(13, 2, 0.1238), (17, 6, 0.1096), (17, 4, 0.1094), (11, 0, 0.0328), (22, 3, 0.0309), (18, 1, 0.0304), (18, 7, 0.0285), (17, 5, 0.0242), (14, 6, 0.024), (20, 7, 0.0238),
                    (11, 1, 0.0234), (16, 4, 0.0193), (19, 4, 0.0169), (30, 4, 0.0165), (19, 1, 0.0163), (11, 4, 0.0162), (14, 5, 0.016), (16, 7, 0.0157), (17, 3, 0.0153), (30, 1, 0.0128),
                    (16, 6, 0.0122), (16, 3, 0.0115), (15, 2, 0.0104), (20, 0, 0.0103), (18, 3, 0.0101), (29, 0, 0.0091), (27, 6, 0.0085), (14, 1, 0.0077), (14, 4, 0.0068), (15, 4, 0.0067)]
    elif 'Qwen3-8B' in model_config['name_or_path']:
        top_heads = [(20, 24, 0.0412), (22, 13, 0.0308), (22, 30, 0.0304), (20, 26, 0.0286), (19, 11, 0.0207), (22, 21, 0.0151), (21, 1, 0.0148), (20, 22, 0.0144), (35, 8, 0.0144), (16, 21, 0.0132),
                    (22, 29, 0.013), (23, 21, 0.0119), (20, 21, 0.0115), (22, 28, 0.0109), (23, 24, 0.0106), (20, 25, 0.0099), (25, 6, 0.0099), (22, 19, 0.0097), (26, 4, 0.0095), (25, 28, 0.0089),
                    (25, 12, 0.0087), (26, 2, 0.0087), (34, 29, 0.0087), (20, 11, 0.0085), (22, 10, 0.0082), (22, 23, 0.0082), (24, 22, 0.0082), (33, 21, 0.0074), (25, 13, 0.0073), (25, 5, 0.0064),
                    (23, 3, 0.0062), (22, 9, 0.0061), (26, 0, 0.0058), (20, 27, 0.0056), (21, 22, 0.0056), (35, 9, 0.0053), (27, 25, 0.0052), (20, 14, 0.0048), (20, 30, 0.0046), (32, 9, 0.0045),
                    (21, 6, 0.0038), (29, 16, 0.0038), (23, 2, 0.0037), (27, 7, 0.0037), (28, 28, 0.0037), (23, 29, 0.0036), (25, 15, 0.0035), (24, 20, 0.0034), (35, 24, 0.0034), (13, 28, 0.0033)]
